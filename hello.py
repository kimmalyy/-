...
nick_name = simpledialog.askstring("이름입력", "당신의 이름은 무엇인가요?")
   ...
   messagebox.showinfo("환영합니다!", "안녕하세요", nick_name, "님!")
play = True
    # 메뉴 선택
while play:
    ...
    if choice == "쉬기":
        ...
        if confirm == "네":
            ...
            if new_name:
                ...
                messagebox.showinfo("이름 변경 완료", "안녕하세요", new_name, "님!")

        elif confirm == "아니오":
            messagebox.showinfo("이름 유지", f"이름을 변경하지 않겠습니다. 여전히 {nick_name}님입니다.")
            messagebox.showinfo("이름 유지", "이름을 변경하지 않겠습니다. 여전히" , nick_name, "님입니다.")
        ...
        messagebox.showinfo("준비중", "이 기능은 아직 준비중 입니다.")
        ...
        messagebox.showinfo("준비 중", "이 기능은 아직 준비중입니다.")
